            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <!-- Active Users Card -->
                        <div class="col-xl-3 col-md-6 mb-4">
                            <a href="{{ route('tenant.sessions') }}" class="text-decoration-none">
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                    Active Users</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">{{ \App\Models\Activity::where('status', 'active')->whereNull('end_time')->count() }}</div>
                                            </div>
                                            <div class="col-auto">
