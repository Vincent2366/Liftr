                    ...
                    <div class="col-lg-5 d-none d-lg-block bg-register-image">
                        @if(isset($themeSettings) && $themeSettings->logo_path)
                            <div class="text-center">
                                <img src="{{ tenant_asset('logos/' . basename($themeSettings->logo_path)) }}" alt="Logo" class="register-logo" onerror="this.onerror=null; this.src='{{ url('img/undraw_profile.svg') }}'; this.classList.add('fallback-logo');">
                            </div>
                        @elseif(isset($tenant) && $tenant->logo)
                            <div class="text-center">
                                <img src="{{ tenant_asset('logos/' . basename($tenant->logo)) }}" alt="{{ $tenant->name }} Logo" class="register-logo" onerror="this.onerror=null; this.src='{{ url('img/undraw_profile.svg') }}'; this.classList.add('fallback-logo');">
                            </div>
                        @else
                            <div class="text-center">
